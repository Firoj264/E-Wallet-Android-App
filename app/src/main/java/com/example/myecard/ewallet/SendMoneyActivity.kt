                ...
                myRef.child("Users").child("UserID").child(FirebaseAuth.getInstance().currentUser!!.uid)
                    .addListenerForSingleValueEvent(object: ValueEventListener{
                        ...
                        override fun onDataChange(snapshot: DataSnapshot) {
                            ...
                            val validPhone = snapshot!!.child("phoneNumber").value
                            if(validPhone == phone){
                            ...
                            val newAmount: Int
                            val databaseAmountValue = (snapshot.child("amount").value).toString().toInt()
                            val receiverName = snapshot.child("name").value.toString()
                            when {
                                ...
                                databaseAmountValue < amount -> {
                                    ...
                                    val addMoneyActivityIntent = Intent(this@SendMoneyActivity,
                                            ...
                                            override fun onDataChange(snapshot: DataSnapshot) {
                                                ...
                                                if(snapshot!!.hasChildren()){
                                                    ...
                                                    myRef.setValue(senderAmount).addOnSuccessListener {
                                                        ...
                                                        amountTextField.text.clear()
                                                        recreate()
                                                        val homeActivityIntent = Intent(this@SendMoneyActivity, HomeActivity::class.java)
